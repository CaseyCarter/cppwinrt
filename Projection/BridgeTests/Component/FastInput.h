...
namespace winrt::Component::implementation
{
    struct FastInput : FastInputT<FastInput>
    {
        ...
        hstring ObservableVector(Windows::Foundation::Collections::IObservableVector<hstring> const& in);
        ...
        hstring ObservableMap(Windows::Foundation::Collections::IObservableMap<hstring, hstring> const& in);
