...
{
    hstring value;
    check_hresult(WINRT_SHIM(IShownTileNotification)->get_Arguments(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::Notification impl_IUserNotification<D>::Notification() const
{
    ...
    check_hresult(WINRT_SHIM(IUserNotification)->get_Notification(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::AppInfo impl_IUserNotification<D>::AppInfo() const
{
    ...
    check_hresult(WINRT_SHIM(IUserNotification)->get_AppInfo(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::DateTime impl_IUserNotification<D>::CreationTime() const
{
    ...
    check_hresult(WINRT_SHIM(IUserNotification)->get_CreationTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(INotificationVisual)->get_Language(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::UI::Notifications::NotificationBinding> impl_INotificationVisual<D>::Bindings() const
{
    ...
    check_hresult(WINRT_SHIM(INotificationVisual)->get_Bindings(put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, hstring> impl_IAdaptiveNotificationContent<D>::Hints() const
{
    ...
    check_hresult(WINRT_SHIM(IAdaptiveNotificationContent)->get_Hints(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(INotificationBinding)->get_Template(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(INotificationBinding)->get_Language(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IMap<hstring, hstring> value;
    check_hresult(WINRT_SHIM(INotificationBinding)->get_Hints(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::AdaptiveNotificationText> impl_INotificationBinding<D>::GetTextElements() const
{
    ...
    check_hresult(WINRT_SHIM(INotificationBinding)->abi_GetTextElements(put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownNotificationBindingsStatics)->get_ToastGeneric(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_Style(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_Wrap(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_MaxLines(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_MinLines(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_TextStacking(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationHintsStatics)->get_Align(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Caption(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Body(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Base(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Subtitle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Title(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Subheader(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_Header(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_TitleNumeral(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_SubheaderNumeral(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_HeaderNumeral(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_CaptionSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_BodySubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_BaseSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_SubtitleSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_TitleSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_SubheaderSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_SubheaderNumeralSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_HeaderSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownAdaptiveNotificationTextStylesStatics)->get_HeaderNumeralSubtle(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAdaptiveNotificationText)->get_Text(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAdaptiveNotificationText)->get_Language(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IToastActivatedEventArgs)->get_Arguments(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::TileUpdater impl_ITileUpdateManagerStatics<D>::CreateTileUpdaterForApplication() const
{
    ...
    check_hresult(WINRT_SHIM(ITileUpdateManagerStatics)->abi_CreateTileUpdaterForApplication(put(updater)));
    return updater;
}
...
template <typename D> Windows::Data::Xml::Dom::XmlDocument impl_ITileUpdateManagerStatics<D>::GetTemplateContent(Windows::UI::Notifications::TileTemplateType type) const
{
    ...
    check_hresult(WINRT_SHIM(ITileUpdateManagerStatics)->abi_GetTemplateContent(type, put(content)));
    return content;
}
...
template <typename D> Windows::UI::Notifications::TileUpdateManagerForUser impl_ITileUpdateManagerStatics2<D>::GetForUser(const Windows::System::User & user) const
{
    ...
    check_hresult(WINRT_SHIM(ITileUpdateManagerStatics2)->abi_GetForUser(get(user), put(result)));
    return result;
}
...
{
    Windows::UI::Notifications::TileUpdater updater { nullptr };
    check_hresult(WINRT_SHIM(ITileUpdateManagerForUser)->abi_CreateTileUpdaterForApplication(put(updater)));
    return updater;
}
...
template <typename D> Windows::System::User impl_ITileUpdateManagerForUser<D>::User() const
{
    ...
    check_hresult(WINRT_SHIM(ITileUpdateManagerForUser)->get_User(put(value)));
    return value;
}

template <typename D> void impl_ITileUpdater<D>::Update(const Windows::UI::Notifications::TileNotification & notification) const
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_Update(get(notification)));
}
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_AddToSchedule(get(scheduledTile)));
}
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_RemoveFromSchedule(get(scheduledTile)));
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::ScheduledTileNotification> impl_ITileUpdater<D>::GetScheduledTileNotifications() const
{
    ...
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_GetScheduledTileNotifications(put(scheduledTiles)));
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_StartPeriodicUpdate(get(tileContent), requestedInterval));
}
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_StartPeriodicUpdateAtTime(get(tileContent), get(startTime), requestedInterval));
}
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_StartPeriodicUpdateBatch(get(tileContents), requestedInterval));
}
...
{
    check_hresult(WINRT_SHIM(ITileUpdater)->abi_StartPeriodicUpdateBatchAtTime(get(tileContents), get(startTime), requestedInterval));
}
...
template <typename D> Windows::UI::Notifications::TileFlyoutUpdater impl_ITileFlyoutUpdateManagerStatics<D>::CreateTileFlyoutUpdaterForApplication() const
{
    ...
    check_hresult(WINRT_SHIM(ITileFlyoutUpdateManagerStatics)->abi_CreateTileFlyoutUpdaterForApplication(put(updater)));
    return updater;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument content { nullptr };
    check_hresult(WINRT_SHIM(ITileFlyoutUpdateManagerStatics)->abi_GetTemplateContent(type, put(content)));
    return content;
}
...
{
    check_hresult(WINRT_SHIM(ITileFlyoutUpdater)->abi_Update(get(notification)));
}
...
{
    check_hresult(WINRT_SHIM(ITileFlyoutUpdater)->abi_StartPeriodicUpdate(get(tileFlyoutContent), requestedInterval));
}
...
{
    check_hresult(WINRT_SHIM(ITileFlyoutUpdater)->abi_StartPeriodicUpdateAtTime(get(tileFlyoutContent), get(startTime), requestedInterval));
}
...
template <typename D> Windows::UI::Notifications::BadgeUpdater impl_IBadgeUpdateManagerStatics<D>::CreateBadgeUpdaterForApplication() const
{
    ...
    check_hresult(WINRT_SHIM(IBadgeUpdateManagerStatics)->abi_CreateBadgeUpdaterForApplication(put(updater)));
    return updater;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument content { nullptr };
    check_hresult(WINRT_SHIM(IBadgeUpdateManagerStatics)->abi_GetTemplateContent(type, put(content)));
    return content;
}
...
template <typename D> Windows::UI::Notifications::BadgeUpdateManagerForUser impl_IBadgeUpdateManagerStatics2<D>::GetForUser(const Windows::System::User & user) const
{
    ...
    check_hresult(WINRT_SHIM(IBadgeUpdateManagerStatics2)->abi_GetForUser(get(user), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Notifications::BadgeUpdater impl_IBadgeUpdateManagerForUser<D>::CreateBadgeUpdaterForApplication() const
{
    ...
    check_hresult(WINRT_SHIM(IBadgeUpdateManagerForUser)->abi_CreateBadgeUpdaterForApplication(put(result)));
    return result;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IBadgeUpdateManagerForUser)->get_User(put(value)));
    return value;
}

template <typename D> void impl_IBadgeUpdater<D>::Update(const Windows::UI::Notifications::BadgeNotification & notification) const
{
    check_hresult(WINRT_SHIM(IBadgeUpdater)->abi_Update(get(notification)));
}
...
{
    check_hresult(WINRT_SHIM(IBadgeUpdater)->abi_StartPeriodicUpdate(get(badgeContent), requestedInterval));
}
...
{
    check_hresult(WINRT_SHIM(IBadgeUpdater)->abi_StartPeriodicUpdateAtTime(get(badgeContent), get(startTime), requestedInterval));
}
...
template <typename D> Windows::UI::Notifications::ToastNotifier impl_IToastNotificationManagerStatics<D>::CreateToastNotifier() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationManagerStatics)->abi_CreateToastNotifier(put(notifier)));
    return notifier;
}
...
{
    check_hresult(WINRT_SHIM(IToastNotifier)->abi_AddToSchedule(get(scheduledToast)));
}
...
{
    check_hresult(WINRT_SHIM(IToastNotifier)->abi_RemoveFromSchedule(get(scheduledToast)));
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::ScheduledToastNotification> impl_IToastNotifier<D>::GetScheduledToastNotifications() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotifier)->abi_GetScheduledToastNotifications(put(scheduledToasts)));
...
template <typename D> Windows::UI::Notifications::TileNotification impl_ITileNotificationFactory<D>::CreateTileNotification(const Windows::Data::Xml::Dom::XmlDocument & content) const
{
    ...
    check_hresult(WINRT_SHIM(ITileNotificationFactory)->abi_CreateTileNotification(get(content), put(notification)));
    return notification;
}
...
template <typename D> Windows::Data::Xml::Dom::XmlDocument impl_ITileNotification<D>::Content() const
{
    ...
    check_hresult(WINRT_SHIM(ITileNotification)->get_Content(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ITileNotification)->put_ExpirationTime(get(value)));
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_ITileNotification<D>::ExpirationTime() const
{
    ...
    check_hresult(WINRT_SHIM(ITileNotification)->get_ExpirationTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ITileNotification)->get_Tag(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::TileFlyoutNotification impl_ITileFlyoutNotificationFactory<D>::CreateTileFlyoutNotification(const Windows::Data::Xml::Dom::XmlDocument & content) const
{
    ...
    check_hresult(WINRT_SHIM(ITileFlyoutNotificationFactory)->abi_CreateTileFlyoutNotification(get(content), put(notification)));
    return notification;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument value { nullptr };
    check_hresult(WINRT_SHIM(ITileFlyoutNotification)->get_Content(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ITileFlyoutNotification)->put_ExpirationTime(get(value)));
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(ITileFlyoutNotification)->get_ExpirationTime(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::BadgeNotification impl_IBadgeNotificationFactory<D>::CreateBadgeNotification(const Windows::Data::Xml::Dom::XmlDocument & content) const
{
    ...
    check_hresult(WINRT_SHIM(IBadgeNotificationFactory)->abi_CreateBadgeNotification(get(content), put(notification)));
    return notification;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument value { nullptr };
    check_hresult(WINRT_SHIM(IBadgeNotification)->get_Content(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IBadgeNotification)->put_ExpirationTime(get(value)));
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IBadgeNotification)->get_ExpirationTime(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::ToastNotification impl_IToastNotificationFactory<D>::CreateToastNotification(const Windows::Data::Xml::Dom::XmlDocument & content) const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationFactory)->abi_CreateToastNotification(get(content), put(notification)));
    return notification;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument value { nullptr };
    check_hresult(WINRT_SHIM(IToastNotification)->get_Content(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IToastNotification)->put_ExpirationTime(get(value)));
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IToastNotification)->get_ExpirationTime(put(value)));
    return value;
}
...
{
    event_token cookie {};
    check_hresult(WINRT_SHIM(IToastNotification)->add_Dismissed(get(handler), &cookie));
    return cookie;
}
...
{
    event_token cookie {};
    check_hresult(WINRT_SHIM(IToastNotification)->add_Activated(get(handler), &cookie));
    return cookie;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IToastNotification)->add_Failed(get(handler), &token));
    return token;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IToastNotification2)->get_Tag(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IToastNotification2)->get_Group(put(value)));
    return value;
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(INotification)->get_ExpirationTime(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(INotification)->put_ExpirationTime(get(value)));
}
...
template <typename D> Windows::UI::Notifications::NotificationVisual impl_INotification<D>::Visual() const
{
    ...
    check_hresult(WINRT_SHIM(INotification)->get_Visual(put(value)));
    return value;
}

template <typename D> void impl_INotification<D>::Visual(const Windows::UI::Notifications::NotificationVisual & value) const
{
    check_hresult(WINRT_SHIM(INotification)->put_Visual(get(value)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IToastNotification3)->get_RemoteId(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::ScheduledToastNotification impl_IScheduledToastNotificationFactory<D>::CreateScheduledToastNotification(const Windows::Data::Xml::Dom::XmlDocument & content, const Windows::Foundation::DateTime & deliveryTime) const
{
    ...
    check_hresult(WINRT_SHIM(IScheduledToastNotificationFactory)->abi_CreateScheduledToastNotification(get(content), get(deliveryTime), put(notification)));
    return notification;
}
...
{
    Windows::UI::Notifications::ScheduledToastNotification notification { nullptr };
    check_hresult(WINRT_SHIM(IScheduledToastNotificationFactory)->abi_CreateScheduledToastNotificationRecurring(get(content), get(deliveryTime), get(snoozeInterval), maximumSnoozeCount, put(notification)));
    return notification;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument value { nullptr };
    check_hresult(WINRT_SHIM(IScheduledToastNotification)->get_Content(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IScheduledToastNotification)->get_DeliveryTime(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::TimeSpan> impl_IScheduledToastNotification<D>::SnoozeInterval() const
{
    ...
    check_hresult(WINRT_SHIM(IScheduledToastNotification)->get_SnoozeInterval(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledToastNotification)->get_Id(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledToastNotification2)->get_Tag(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledToastNotification2)->get_Group(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledToastNotification3)->get_RemoteId(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::ScheduledTileNotification impl_IScheduledTileNotificationFactory<D>::CreateScheduledTileNotification(const Windows::Data::Xml::Dom::XmlDocument & content, const Windows::Foundation::DateTime & deliveryTime) const
{
    ...
    check_hresult(WINRT_SHIM(IScheduledTileNotificationFactory)->abi_CreateScheduledTileNotification(get(content), get(deliveryTime), put(notification)));
    return notification;
}
...
{
    Windows::Data::Xml::Dom::XmlDocument value { nullptr };
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->get_Content(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->get_DeliveryTime(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->put_ExpirationTime(get(value)));
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->get_ExpirationTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->get_Tag(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IScheduledTileNotification)->get_Id(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::ToastNotificationHistory impl_IToastNotificationManagerStatics2<D>::History() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationManagerStatics2)->get_History(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Notifications::ToastNotificationManagerForUser impl_IToastNotificationManagerStatics4<D>::GetForUser(const Windows::System::User & user) const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationManagerStatics4)->abi_GetForUser(get(user), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Notifications::ToastNotifier impl_IToastNotificationManagerForUser<D>::CreateToastNotifier() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationManagerForUser)->abi_CreateToastNotifier(put(result)));
    return result;
}
...
{
    Windows::UI::Notifications::ToastNotificationHistory value { nullptr };
    check_hresult(WINRT_SHIM(IToastNotificationManagerForUser)->get_History(put(value)));
    return value;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IToastNotificationManagerForUser)->get_User(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::ToastNotification> impl_IToastNotificationHistory2<D>::GetHistory() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationHistory2)->abi_GetHistory(put(toasts)));
    return toasts;
}
...
{
    hstring argument;
    check_hresult(WINRT_SHIM(IToastNotificationActionTriggerDetail)->get_Argument(put(argument)));
    return argument;
}
...
template <typename D> Windows::Foundation::Collections::ValueSet impl_IToastNotificationActionTriggerDetail<D>::UserInput() const
{
    ...
    check_hresult(WINRT_SHIM(IToastNotificationActionTriggerDetail)->get_UserInput(put(inputs)));
    return inputs;
}
