...
{
    check_hresult((*(abi<DataProviderHandler> **)this)->abi_Invoke(get(request)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_Text(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_Uri(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_Html(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_Rtf(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_Bitmap(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics)->get_StorageItems(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics2)->get_WebLink(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStandardDataFormatsStatics2)->get_ApplicationLink(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_Title(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_Description(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Streams::RandomAccessStreamReference impl_IDataPackagePropertySetView<D>::Thumbnail() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_Thumbnail(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IDataPackagePropertySetView<D>::FileTypes() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_FileTypes(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_ApplicationName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Uri impl_IDataPackagePropertySetView<D>::ApplicationListingUri() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView)->get_ApplicationListingUri(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView2)->get_PackageFamilyName(put(value)));
    return value;
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView2)->get_ContentSourceWebLink(put(value)));
    return value;
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView2)->get_ContentSourceApplicationLink(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IDataPackagePropertySetView2<D>::Square30x30Logo() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView2)->get_Square30x30Logo(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Color impl_IDataPackagePropertySetView2<D>::LogoBackgroundColor() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView2)->get_LogoBackgroundColor(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySetView3)->get_EnterpriseId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->get_Title(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->get_Description(put(value)));
    return value;
}
...
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->get_Thumbnail(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->put_Thumbnail(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IDataPackagePropertySet<D>::FileTypes() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->get_FileTypes(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet)->get_ApplicationName(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->put_ContentSourceApplicationLink(get(value)));
}

template <typename D> hstring impl_IDataPackagePropertySet2<D>::PackageFamilyName() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->get_PackageFamilyName(put(value)));
    return value;
}
...
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->get_Square30x30Logo(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->put_Square30x30Logo(get(value)));
}

template <typename D> Windows::UI::Color impl_IDataPackagePropertySet2<D>::LogoBackgroundColor() const
{
    Windows::UI::Color value {};
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->get_LogoBackgroundColor(put(value)));
    return value;
}

template <typename D> void impl_IDataPackagePropertySet2<D>::LogoBackgroundColor(const Windows::UI::Color & value) const
{
    check_hresult(WINRT_SHIM(IDataPackagePropertySet2)->put_LogoBackgroundColor(get(value)));
}

template <typename D> hstring impl_IDataPackagePropertySet3<D>::EnterpriseId() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataPackagePropertySet3)->get_EnterpriseId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDataProviderRequest)->get_FormatId(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::DateTime impl_IDataProviderRequest<D>::Deadline() const
{
    ...
    check_hresult(WINRT_SHIM(IDataProviderRequest)->get_Deadline(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataProviderDeferral impl_IDataProviderRequest<D>::GetDeferral() const
{
    ...
    check_hresult(WINRT_SHIM(IDataProviderRequest)->abi_GetDeferral(put(value)));
    return value;
}

template <typename D> void impl_IDataProviderRequest<D>::SetData(const Windows::IInspectable & value) const
{
    check_hresult(WINRT_SHIM(IDataProviderRequest)->abi_SetData(get(value)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IOperationCompletedEventArgs2)->get_AcceptedFormatId(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackagePropertySetView impl_IDataPackageView<D>::Properties() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->get_Properties(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IDataPackageView<D>::AvailableFormats() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->get_AvailableFormats(put(formatIds)));
    return formatIds;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_IDataPackageView<D>::GetTextAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetTextAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Uri> impl_IDataPackageView<D>::GetUriAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetUriAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetHtmlFormatAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IMapView<hstring, Windows::Storage::Streams::RandomAccessStreamReference>> impl_IDataPackageView<D>::GetResourceMapAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetResourceMapAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetRtfAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::Streams::RandomAccessStreamReference> impl_IDataPackageView<D>::GetBitmapAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetBitmapAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Storage::IStorageItem>> impl_IDataPackageView<D>::GetStorageItemsAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView)->abi_GetStorageItemsAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Uri> operation;
    check_hresult(WINRT_SHIM(IDataPackageView2)->abi_GetApplicationLinkAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Uri> operation;
    check_hresult(WINRT_SHIM(IDataPackageView2)->abi_GetWebLinkAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> impl_IDataPackageView3<D>::RequestAccessAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackageView3)->abi_RequestAccessAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackageView impl_IDataPackage<D>::GetView() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackage)->abi_GetView(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackagePropertySet impl_IDataPackage<D>::Properties() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackage)->get_Properties(put(value)));
    return value;
}
...
template <typename D> event_token impl_IDataPackage<D>::OperationCompleted(const Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::DataTransfer::DataPackage, Windows::ApplicationModel::DataTransfer::OperationCompletedEventArgs> & handler) const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackage)->add_OperationCompleted(get(handler), &eventCookie));
    return eventCookie;
}
...
{
    event_token eventCookie {};
    check_hresult(WINRT_SHIM(IDataPackage)->add_Destroyed(get(handler), &eventCookie));
    return eventCookie;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::Storage::Streams::RandomAccessStreamReference> impl_IDataPackage<D>::ResourceMap() const
{
    ...
    check_hresult(WINRT_SHIM(IDataPackage)->get_ResourceMap(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IDataPackage)->abi_SetBitmap(get(value)));
}
...
{
    check_hresult(WINRT_SHIM(IDataPackage)->abi_SetStorageItemsReadOnly(get(value)));
}
...
{
    check_hresult(WINRT_SHIM(IDataPackage)->abi_SetStorageItems(get(value), readOnly));
}

template <typename D> void impl_IDataPackage2<D>::SetApplicationLink(const Windows::Foundation::Uri & value) const
{
    check_hresult(WINRT_SHIM(IDataPackage2)->abi_SetApplicationLink(get(value)));
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackageView impl_IClipboardStatics<D>::GetContent() const
{
    ...
    check_hresult(WINRT_SHIM(IClipboardStatics)->abi_GetContent(put(content)));
    return content;
}
...
{
    check_hresult(WINRT_SHIM(IClipboardStatics)->abi_SetContent(get(content)));
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IClipboardStatics)->add_ContentChanged(get(changeHandler), &token));
    return token;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataRequestDeferral impl_IDataRequest<D>::GetDeferral() const
{
    ...
    check_hresult(WINRT_SHIM(IDataRequest)->abi_GetDeferral(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataRequest impl_IDataRequestedEventArgs<D>::Request() const
{
    ...
    check_hresult(WINRT_SHIM(IDataRequestedEventArgs)->get_Request(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ITargetApplicationChosenEventArgs)->get_ApplicationName(put(value)));
    return value;
}
...
{
    event_token eventCookie {};
    check_hresult(WINRT_SHIM(IDataTransferManager)->add_DataRequested(get(eventHandler), &eventCookie));
    return eventCookie;
}
...
{
    event_token eventCookie {};
    check_hresult(WINRT_SHIM(IDataTransferManager)->add_TargetApplicationChosen(get(eventHandler), &eventCookie));
    return eventCookie;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataTransferManager impl_IDataTransferManagerStatics<D>::GetForCurrentView() const
{
    ...
    check_hresult(WINRT_SHIM(IDataTransferManagerStatics)->abi_GetForCurrentView(put(value)));
    return value;
}
...
{
    hstring outToken;
    check_hresult(WINRT_SHIM(ISharedStorageAccessManagerStatics)->abi_AddFile(get(file), put(outToken)));
    return outToken;
}
