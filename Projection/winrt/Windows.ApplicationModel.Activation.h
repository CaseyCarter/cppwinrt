...
template <typename D> Windows::Foundation::Rect impl_ISplashScreen<D>::ImageLocation() const
{
    ...
    check_hresult(WINRT_SHIM(ISplashScreen)->get_ImageLocation(put(value)));
    return value;
}
...
{
    event_token cookie {};
    check_hresult(WINRT_SHIM(ISplashScreen)->add_Dismissed(get(handler), &cookie));
    return cookie;
}
...
template <typename D> Windows::ApplicationModel::Activation::SplashScreen impl_IActivatedEventArgs<D>::SplashScreen() const
{
    ...
    check_hresult(WINRT_SHIM(IActivatedEventArgs)->get_SplashScreen(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderActivatedEventArgs)->get_Verb(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentsProvider::AddAppointmentOperation impl_IAppointmentsProviderAddAppointmentActivatedEventArgs<D>::AddAppointmentOperation() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderAddAppointmentActivatedEventArgs)->get_AddAppointmentOperation(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentsProvider::ReplaceAppointmentOperation impl_IAppointmentsProviderReplaceAppointmentActivatedEventArgs<D>::ReplaceAppointmentOperation() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderReplaceAppointmentActivatedEventArgs)->get_ReplaceAppointmentOperation(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentsProvider::RemoveAppointmentOperation impl_IAppointmentsProviderRemoveAppointmentActivatedEventArgs<D>::RemoveAppointmentOperation() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderRemoveAppointmentActivatedEventArgs)->get_RemoveAppointmentOperation(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs<D>::InstanceStartDate() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs)->get_InstanceStartDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs)->get_LocalId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs)->get_RoamingId(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::DateTime impl_IAppointmentsProviderShowTimeFrameActivatedEventArgs<D>::TimeToShow() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderShowTimeFrameActivatedEventArgs)->get_TimeToShow(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::TimeSpan impl_IAppointmentsProviderShowTimeFrameActivatedEventArgs<D>::Duration() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentsProviderShowTimeFrameActivatedEventArgs)->get_Duration(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountProviderOperation impl_IUserDataAccountProviderActivatedEventArgs<D>::Operation() const
{
    ...
    check_hresult(WINRT_SHIM(IUserDataAccountProviderActivatedEventArgs)->get_Operation(put(value)));
    return value;
}
...
template <typename D> Windows::System::User impl_IActivatedEventArgsWithUser<D>::User() const
{
    ...
    check_hresult(WINRT_SHIM(IActivatedEventArgsWithUser)->get_User(put(value)));
    return value;
}
...
template <typename D> Windows::UI::ViewManagement::ActivationViewSwitcher impl_IViewSwitcherProvider<D>::ViewSwitcher() const
{
    ...
    check_hresult(WINRT_SHIM(IViewSwitcherProvider)->get_ViewSwitcher(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILaunchActivatedEventArgs)->get_Arguments(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILaunchActivatedEventArgs)->get_TileId(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Activation::TileActivatedInfo impl_ILaunchActivatedEventArgs2<D>::TileActivatedInfo() const
{
    ...
    check_hresult(WINRT_SHIM(ILaunchActivatedEventArgs2)->get_TileActivatedInfo(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ISearchActivatedEventArgs)->get_QueryText(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ISearchActivatedEventArgs)->get_Language(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails impl_ISearchActivatedEventArgsWithLinguisticDetails<D>::LinguisticDetails() const
{
    ...
    check_hresult(WINRT_SHIM(ISearchActivatedEventArgsWithLinguisticDetails)->get_LinguisticDetails(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::ShareTarget::ShareOperation impl_IShareTargetActivatedEventArgs<D>::ShareOperation() const
{
    ...
    check_hresult(WINRT_SHIM(IShareTargetActivatedEventArgs)->get_ShareOperation(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Storage::IStorageItem> impl_IFileActivatedEventArgs<D>::Files() const
{
    ...
    check_hresult(WINRT_SHIM(IFileActivatedEventArgs)->get_Files(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileActivatedEventArgs)->get_Verb(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Search::StorageFileQueryResult impl_IFileActivatedEventArgsWithNeighboringFiles<D>::NeighboringFilesQuery() const
{
    ...
    check_hresult(WINRT_SHIM(IFileActivatedEventArgsWithNeighboringFiles)->get_NeighboringFilesQuery(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileActivatedEventArgsWithCallerPackageFamilyName)->get_CallerPackageFamilyName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Uri impl_IProtocolActivatedEventArgs<D>::Uri() const
{
    ...
    check_hresult(WINRT_SHIM(IProtocolActivatedEventArgs)->get_Uri(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData)->get_CallerPackageFamilyName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::ValueSet impl_IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData<D>::Data() const
{
    ...
    check_hresult(WINRT_SHIM(IProtocolActivatedEventArgsWithCallerPackageFamilyNameAndData)->get_Data(put(value)));
    return value;
}
...
template <typename D> Windows::System::ProtocolForResultsOperation impl_IProtocolForResultsActivatedEventArgs<D>::ProtocolForResultsOperation() const
{
    ...
    check_hresult(WINRT_SHIM(IProtocolForResultsActivatedEventArgs)->get_ProtocolForResultsOperation(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Pickers::Provider::FileOpenPickerUI impl_IFileOpenPickerActivatedEventArgs<D>::FileOpenPickerUI() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPickerActivatedEventArgs)->get_FileOpenPickerUI(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileOpenPickerActivatedEventArgs2)->get_CallerPackageFamilyName(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Pickers::Provider::FileSavePickerUI impl_IFileSavePickerActivatedEventArgs<D>::FileSavePickerUI() const
{
    ...
    check_hresult(WINRT_SHIM(IFileSavePickerActivatedEventArgs)->get_FileSavePickerUI(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePickerActivatedEventArgs2)->get_CallerPackageFamilyName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePickerActivatedEventArgs2)->get_EnterpriseId(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Provider::CachedFileUpdaterUI impl_ICachedFileUpdaterActivatedEventArgs<D>::CachedFileUpdaterUI() const
{
    ...
    check_hresult(WINRT_SHIM(ICachedFileUpdaterActivatedEventArgs)->get_CachedFileUpdaterUI(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDeviceActivatedEventArgs)->get_DeviceInformationId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDeviceActivatedEventArgs)->get_Verb(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IPickerReturnedActivatedEventArgs)->get_PickerOperationId(put(value)));
    return value;
}
...
template <typename D> Windows::IInspectable impl_IRestrictedLaunchActivatedEventArgs<D>::SharedContext() const
{
    ...
    check_hresult(WINRT_SHIM(IRestrictedLaunchActivatedEventArgs)->get_SharedContext(put(value)));
    return value;
}
...
{
    Windows::IInspectable value;
    check_hresult(WINRT_SHIM(ILockScreenActivatedEventArgs)->get_Info(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::ValueSet value { nullptr };
    check_hresult(WINRT_SHIM(IContinuationActivatedEventArgs)->get_ContinuationData(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Storage::StorageFile> impl_IFileOpenPickerContinuationEventArgs<D>::Files() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPickerContinuationEventArgs)->get_Files(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::StorageFile impl_IFileSavePickerContinuationEventArgs<D>::File() const
{
    ...
    check_hresult(WINRT_SHIM(IFileSavePickerContinuationEventArgs)->get_File(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::StorageFolder impl_IFolderPickerContinuationEventArgs<D>::Folder() const
{
    ...
    check_hresult(WINRT_SHIM(IFolderPickerContinuationEventArgs)->get_Folder(put(value)));
    return value;
}
...
template <typename D> Windows::Security::Authentication::Web::WebAuthenticationResult impl_IWebAuthenticationBrokerContinuationEventArgs<D>::WebAuthenticationResult() const
{
    ...
    check_hresult(WINRT_SHIM(IWebAuthenticationBrokerContinuationEventArgs)->get_WebAuthenticationResult(put(result)));
    return result;
}
...
template <typename D> Windows::Security::Authentication::Web::Provider::IWebAccountProviderOperation impl_IWebAccountProviderActivatedEventArgs<D>::Operation() const
{
    ...
    check_hresult(WINRT_SHIM(IWebAccountProviderActivatedEventArgs)->get_Operation(put(value)));
    return value;
}
...
{
    hstring argument;
    check_hresult(WINRT_SHIM(IToastNotificationActivatedEventArgs)->get_Argument(put(argument)));
    return argument;
}
...
{
    Windows::Foundation::Collections::ValueSet value { nullptr };
    check_hresult(WINRT_SHIM(IToastNotificationActivatedEventArgs)->get_UserInput(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDialReceiverActivatedEventArgs)->get_AppName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::ShownTileNotification> impl_ITileActivatedInfo<D>::RecentlyShownNotifications() const
{
    ...
    check_hresult(WINRT_SHIM(ITileActivatedInfo)->get_RecentlyShownNotifications(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Background::IBackgroundTaskInstance impl_IBackgroundActivatedEventArgs<D>::TaskInstance() const
{
    ...
    check_hresult(WINRT_SHIM(IBackgroundActivatedEventArgs)->get_TaskInstance(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::Enumeration::DeviceInformation impl_IDevicePairingActivatedEventArgs<D>::DeviceInformation() const
{
    ...
    check_hresult(WINRT_SHIM(IDevicePairingActivatedEventArgs)->get_DeviceInformation(put(value)));
    return value;
}
...
template <typename D> Windows::Media::SpeechRecognition::SpeechRecognitionResult impl_IVoiceCommandActivatedEventArgs<D>::Result() const
{
    ...
    check_hresult(WINRT_SHIM(IVoiceCommandActivatedEventArgs)->get_Result(put(value)));
    return value;
}
