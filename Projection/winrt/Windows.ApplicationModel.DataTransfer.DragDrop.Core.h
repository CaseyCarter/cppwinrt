...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackageView impl_ICoreDragInfo<D>::Data() const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragInfo)->get_Data(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Point impl_ICoreDragInfo<D>::Position() const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragInfo)->get_Position(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ICoreDragUIOverride)->abi_SetContentFromSoftwareBitmap(get(softwareBitmap)));
}
...
{
    check_hresult(WINRT_SHIM(ICoreDragUIOverride)->abi_SetContentFromSoftwareBitmapWithAnchorPoint(get(softwareBitmap), get(anchorPoint)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ICoreDragUIOverride)->get_Caption(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation> impl_ICoreDropOperationTarget<D>::EnterAsync(const Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragInfo & dragInfo, const Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragUIOverride & dragUIOverride) const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDropOperationTarget)->abi_EnterAsync(get(dragInfo), get(dragUIOverride), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation> returnValue;
    check_hresult(WINRT_SHIM(ICoreDropOperationTarget)->abi_OverAsync(get(dragInfo), get(dragUIOverride), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_ICoreDropOperationTarget<D>::LeaveAsync(const Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragInfo & dragInfo) const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDropOperationTarget)->abi_LeaveAsync(get(dragInfo), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation> returnValue;
    check_hresult(WINRT_SHIM(ICoreDropOperationTarget)->abi_DropAsync(get(dragInfo), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DataPackage impl_ICoreDragOperation<D>::Data() const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragOperation)->get_Data(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ICoreDragOperation)->abi_SetDragUIContentFromSoftwareBitmap(get(softwareBitmap)));
}
...
{
    check_hresult(WINRT_SHIM(ICoreDragOperation)->abi_SetDragUIContentFromSoftwareBitmapWithAnchorPoint(get(softwareBitmap), get(anchorPoint)));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::DataTransfer::DataPackageOperation> impl_ICoreDragOperation<D>::StartAsync() const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragOperation)->abi_StartAsync(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragDropManager impl_ICoreDragDropManagerStatics<D>::GetForCurrentView() const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragDropManagerStatics)->abi_GetForCurrentView(put(value)));
    return value;
}
...
template <typename D> event_token impl_ICoreDragDropManager<D>::TargetRequested(const Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDragDropManager, Windows::ApplicationModel::DataTransfer::DragDrop::Core::CoreDropOperationTargetRequestedEventArgs> & value) const
{
    ...
    check_hresult(WINRT_SHIM(ICoreDragDropManager)->add_TargetRequested(get(value), &returnValue));
    return returnValue;
}
...
{
    check_hresult(WINRT_SHIM(ICoreDropOperationTargetRequestedEventArgs)->abi_SetTarget(get(target)));
}
