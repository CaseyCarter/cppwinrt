...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IDateTimeFormatter<D>::Languages() const
{
    ...
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_Languages(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_GeographicRegion(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_Calendar(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_Clock(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_NumeralSystem(put(value)));
    return value;
}

template <typename D> void impl_IDateTimeFormatter<D>::NumeralSystem(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->put_NumeralSystem(get(value)));
}

template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IDateTimeFormatter<D>::Patterns() const
{
    Windows::Foundation::Collections::IVectorView<hstring> value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_Patterns(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_Template(put(value)));
    return value;
}
...
{
    hstring result;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->abi_Format(get(value), put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_ResolvedLanguage(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IDateTimeFormatter)->get_ResolvedGeographicRegion(put(value)));
    return value;
}
...
template <typename D> Windows::Globalization::DateTimeFormatting::DateTimeFormatter impl_IDateTimeFormatterFactory<D>::CreateDateTimeFormatter(hstring_view formatTemplate) const
{
    ...
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatter(get(formatTemplate), put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterLanguages(get(formatTemplate), get(languages), put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterContext(get(formatTemplate), get(languages), get(geographicRegion), get(calendar), get(clock), put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterDate(yearFormat, monthFormat, dayFormat, dayOfWeekFormat, put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterTime(hourFormat, minuteFormat, secondFormat, put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterDateTimeLanguages(yearFormat, monthFormat, dayFormat, dayOfWeekFormat, hourFormat, minuteFormat, secondFormat, get(languages), put(result)));
    return result;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter result { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterFactory)->abi_CreateDateTimeFormatterDateTimeContext(yearFormat, monthFormat, dayFormat, dayOfWeekFormat, hourFormat, minuteFormat, secondFormat, get(languages), get(geographicRegion), get(calendar), get(clock), put(result)));
    return result;
}
...
template <typename D> Windows::Globalization::DateTimeFormatting::DateTimeFormatter impl_IDateTimeFormatterStatics<D>::LongDate() const
{
    ...
    check_hresult(WINRT_SHIM(IDateTimeFormatterStatics)->get_LongDate(put(value)));
    return value;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter value { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterStatics)->get_LongTime(put(value)));
    return value;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter value { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterStatics)->get_ShortDate(put(value)));
    return value;
}
...
{
    Windows::Globalization::DateTimeFormatting::DateTimeFormatter value { nullptr };
    check_hresult(WINRT_SHIM(IDateTimeFormatterStatics)->get_ShortTime(put(value)));
    return value;
}
...
{
    hstring result;
    check_hresult(WINRT_SHIM(IDateTimeFormatter2)->abi_FormatUsingTimeZone(get(datetime), get(timeZoneId), put(result)));
    return result;
}
