...
template <typename D> Windows::ApplicationModel::Store::LicenseInformation impl_ICurrentApp<D>::LicenseInformation() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentApp)->get_LicenseInformation(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Uri impl_ICurrentApp<D>::LinkUri() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentApp)->get_LinkUri(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_ICurrentApp<D>::RequestAppPurchaseAsync(bool includeReceipt) const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentApp)->abi_RequestAppPurchaseAsync(includeReceipt, put(requestAppPurchaseOperation)));
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> impl_ICurrentApp<D>::LoadListingInformationAsync() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentApp)->abi_LoadListingInformationAsync(put(loadListingOperation)));
...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_ICurrentApp<D>::GetAppReceiptAsync() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentApp)->abi_GetAppReceiptAsync(put(appReceiptOperation)));
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::UnfulfilledConsumable>> impl_ICurrentAppWithConsumables<D>::GetUnfulfilledConsumablesAsync() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentAppWithConsumables)->abi_GetUnfulfilledConsumablesAsync(put(getUnfulfilledConsumablesOperation)));
...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_ICurrentAppWithCampaignId<D>::GetAppPurchaseCampaignIdAsync() const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentAppWithCampaignId)->abi_GetAppPurchaseCampaignIdAsync(put(operation)));
    return operation;
}
...
{
    Windows::ApplicationModel::Store::LicenseInformation value { nullptr };
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->get_LicenseInformation(put(value)));
    return value;
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->get_LinkUri(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> requestAppPurchaseOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->abi_RequestAppPurchaseAsync(includeReceipt, put(requestAppPurchaseOperation)));
    return requestAppPurchaseOperation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> loadListingOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->abi_LoadListingInformationAsync(put(loadListingOperation)));
    return loadListingOperation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> appReceiptOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->abi_GetAppReceiptAsync(put(appReceiptOperation)));
    return appReceiptOperation;
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_ICurrentAppSimulator<D>::ReloadSimulatorAsync(const Windows::Storage::StorageFile & simulatorSettingsFile) const
{
    ...
    check_hresult(WINRT_SHIM(ICurrentAppSimulator)->abi_ReloadSimulatorAsync(get(simulatorSettingsFile), put(reloadSimulatorOperation)));
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulatorWithCampaignId)->abi_GetAppPurchaseCampaignIdAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::UnfulfilledConsumable>> getUnfulfilledConsumablesOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulatorWithConsumables)->abi_GetUnfulfilledConsumablesAsync(put(getUnfulfilledConsumablesOperation)));
    return getUnfulfilledConsumablesOperation;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IPurchaseResults)->get_ReceiptXml(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IPurchaseResults)->get_OfferId(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::ProductLicense> impl_ILicenseInformation<D>::ProductLicenses() const
{
    ...
    check_hresult(WINRT_SHIM(ILicenseInformation)->get_ProductLicenses(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::DateTime impl_ILicenseInformation<D>::ExpirationDate() const
{
    ...
    check_hresult(WINRT_SHIM(ILicenseInformation)->get_ExpirationDate(put(value)));
    return value;
}
...
{
    event_token cookie {};
    check_hresult(WINRT_SHIM(ILicenseInformation)->add_LicenseChanged(get(handler), &cookie));
    return cookie;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductLicense)->get_ProductId(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IProductLicense)->get_ExpirationDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation)->get_CurrentMarket(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation)->get_Description(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::ProductListing> impl_IListingInformation<D>::ProductListings() const
{
    ...
    check_hresult(WINRT_SHIM(IListingInformation)->get_ProductListings(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation)->get_FormattedPrice(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation2)->get_FormattedBasePrice(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IListingInformation2)->get_SaleEndDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IListingInformation2)->get_CurrencyCode(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListing)->get_ProductId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListing)->get_FormattedPrice(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListing)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListing2)->get_FormattedBasePrice(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IProductListing2)->get_SaleEndDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListing2)->get_CurrencyCode(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> loadListingOperation;
    check_hresult(WINRT_SHIM(ICurrentAppStaticsWithFiltering)->abi_LoadListingInformationByProductIdsAsync(get(productIds), put(loadListingOperation)));
    return loadListingOperation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> loadListingOperation;
    check_hresult(WINRT_SHIM(ICurrentAppStaticsWithFiltering)->abi_LoadListingInformationByKeywordsAsync(get(keywords), put(loadListingOperation)));
    return loadListingOperation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> loadListingOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulatorStaticsWithFiltering)->abi_LoadListingInformationByProductIdsAsync(get(productIds), put(loadListingOperation)));
    return loadListingOperation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::ListingInformation> loadListingOperation;
    check_hresult(WINRT_SHIM(ICurrentAppSimulatorStaticsWithFiltering)->abi_LoadListingInformationByKeywordsAsync(get(keywords), put(loadListingOperation)));
    return loadListingOperation;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListingWithMetadata)->get_Description(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IIterable<hstring> impl_IProductListingWithMetadata<D>::Keywords() const
{
    ...
    check_hresult(WINRT_SHIM(IProductListingWithMetadata)->get_Keywords(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductListingWithMetadata)->get_Tag(put(value)));
    return value;
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(IProductListingWithMetadata)->get_ImageUri(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IUnfulfilledConsumable)->get_ProductId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IUnfulfilledConsumable)->get_OfferId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductPurchaseDisplayProperties)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IProductPurchaseDisplayProperties)->get_Description(put(value)));
    return value;
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(IProductPurchaseDisplayProperties)->get_Image(put(value)));
    return value;
}
