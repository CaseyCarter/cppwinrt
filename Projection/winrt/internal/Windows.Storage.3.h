...
struct PathIO
{
    ...
    static Windows::Foundation::IAsyncAction WriteLinesAsync(hstring_view absolutePath, const Windows::Foundation::Collections::IIterable<hstring> & lines);
    static Windows::Foundation::IAsyncAction WriteLinesAsync(hstring_view absolutePath, const Windows::Foundation::Collections::IIterable<hstring> & lines, Windows::Storage::Streams::UnicodeEncoding encoding);
    static Windows::Foundation::IAsyncAction AppendLinesAsync(hstring_view absolutePath, const Windows::Foundation::Collections::IIterable<hstring> & lines);
