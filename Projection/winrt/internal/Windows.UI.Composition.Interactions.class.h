...
#include "Windows.UI.Composition.Interactions.interface.h"
...
struct WINRT_EBO CompositionInteractionSourceCollection :
    ...
    impl::require<CompositionInteractionSourceCollection, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
...
struct WINRT_EBO InteractionTracker :
    ...
    impl::require<InteractionTracker, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
...
struct WINRT_EBO InteractionTrackerInertiaModifier :
    ...
    impl::require<InteractionTrackerInertiaModifier, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
...
struct WINRT_EBO InteractionTrackerInertiaMotion :
    ...
    impl::require<InteractionTrackerInertiaMotion, Windows::UI::Composition::Interactions::IInteractionTrackerInertiaModifier, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
...
struct WINRT_EBO InteractionTrackerInertiaRestingValue :
    ...
    impl::require<InteractionTrackerInertiaRestingValue, Windows::UI::Composition::Interactions::IInteractionTrackerInertiaModifier, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
...
struct WINRT_EBO VisualInteractionSource :
    ...
    impl::require<VisualInteractionSource, Windows::UI::Composition::Interactions::ICompositionInteractionSource, Windows::UI::Composition::ICompositionObject, Windows::UI::Composition::ICompositionObject2>
{
