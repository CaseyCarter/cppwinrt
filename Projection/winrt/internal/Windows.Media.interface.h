...
struct IAudioBuffer :
    ...
    impl::require<IAudioBuffer, Windows::Foundation::IMemoryBuffer>
{
...
struct IAudioFrame :
    ...
    impl::require<IAudioFrame, Windows::Media::IMediaFrame>
{
...
struct IVideoFrame :
    ...
    impl::require<IVideoFrame, Windows::Media::IMediaFrame>
{
