...
#include "Windows.Devices.Bluetooth.interface.h"
...
struct WINRT_EBO BluetoothDevice :
    ...
    impl::require<BluetoothDevice, Windows::Devices::Bluetooth::IBluetoothDevice2, Windows::Devices::Bluetooth::IBluetoothDevice3>
{
...
struct WINRT_EBO BluetoothLEDevice :
    ...
    impl::require<BluetoothLEDevice, Windows::Devices::Bluetooth::IBluetoothLEDevice2>
{
