    ...
    impl::require<DateTimeFormatter, Windows::Globalization::DateTimeFormatting::IDateTimeFormatter2>
{
    ...
    DateTimeFormatter(hstring_view formatTemplate, const Windows::Foundation::Collections::IIterable<hstring> & languages);
    DateTimeFormatter(hstring_view formatTemplate, const Windows::Foundation::Collections::IIterable<hstring> & languages, hstring_view geographicRegion, hstring_view calendar, hstring_view clock);
