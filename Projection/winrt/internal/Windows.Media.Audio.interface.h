...
#include "Windows.Media.Audio.abi.h"
#include "Windows.Foundation.interface.h"
#include "Windows.Media.Effects.interface.h"
...
struct IAudioDeviceInputNode :
    ...
    impl::require<IAudioDeviceInputNode, Windows::Media::Audio::IAudioInputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioDeviceOutputNode :
    ...
    impl::require<IAudioDeviceOutputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioFileInputNode :
    ...
    impl::require<IAudioFileInputNode, Windows::Media::Audio::IAudioInputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioFileOutputNode :
    ...
    impl::require<IAudioFileOutputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioFrameInputNode :
    ...
    impl::require<IAudioFrameInputNode, Windows::Media::Audio::IAudioInputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioFrameOutputNode :
    ...
    impl::require<IAudioFrameOutputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioGraph2 :
    ...
    impl::require<IAudioGraph2, Windows::Media::Audio::IAudioGraph>
{
...
struct IAudioInputNode :
    ...
    impl::require<IAudioInputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioInputNode2 :
    ...
    impl::require<IAudioInputNode2, Windows::Media::Audio::IAudioInputNode, Windows::Media::Audio::IAudioNode>
{
...
struct IAudioNodeWithListener :
    ...
    impl::require<IAudioNodeWithListener, Windows::Media::Audio::IAudioNode>
{
