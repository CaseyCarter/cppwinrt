...
#include "Windows.Storage.Compression.abi.h"
...
struct ICompressor :
    ...
    impl::require<ICompressor, Windows::Storage::Streams::IOutputStream>
{
...
struct IDecompressor :
    ...
    impl::require<IDecompressor, Windows::Storage::Streams::IInputStream>
{
