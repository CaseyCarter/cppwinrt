...
#include "Windows.Media.Playback.interface.h"
...
struct IFaceDetectionEffectFrame :
    ...
    impl::require<IFaceDetectionEffectFrame, Windows::Media::IMediaFrame>
{
...
struct IMediaSource2 :
    ...
    impl::require<IMediaSource2, Windows::Media::Playback::IMediaPlaybackSource>
{
...
struct IMediaSource3 :
    ...
    impl::require<IMediaSource3, Windows::Media::Core::IMediaSource2, Windows::Media::Playback::IMediaPlaybackSource>
{
...
struct ISceneAnalysisEffectFrame :
    ...
    impl::require<ISceneAnalysisEffectFrame, Windows::Media::IMediaFrame>
{
