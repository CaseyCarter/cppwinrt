...
#include "Windows.UI.Xaml.Media.Imaging.interface.h"
...
struct WINRT_EBO SoftwareBitmapSource :
    ...
    impl::require<SoftwareBitmapSource, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2, Windows::UI::Xaml::Media::IImageSource>
{
