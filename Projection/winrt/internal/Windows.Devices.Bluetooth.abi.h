...
#include "Windows.Devices.Bluetooth.Rfcomm.abi.h"
#include "Windows.Devices.Enumeration.abi.h"
#include "Windows.Devices.Bluetooth.GenericAttributeProfile.abi.h"
