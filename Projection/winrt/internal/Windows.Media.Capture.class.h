...
#include "Windows.Media.Capture.interface.h"
...
struct WINRT_EBO MediaCapture :
    ...
    impl::require<MediaCapture, Windows::Media::Capture::IMediaCapture2, Windows::Media::Capture::IMediaCapture3, Windows::Media::Capture::IMediaCapture4, Windows::Media::Capture::IMediaCapture5, Windows::Media::Capture::IMediaCaptureVideoPreview>
{
