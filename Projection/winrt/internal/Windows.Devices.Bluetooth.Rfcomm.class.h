...
#include "Windows.Devices.Bluetooth.Rfcomm.interface.h"
...
struct WINRT_EBO RfcommDeviceService :
    ...
    impl::require<RfcommDeviceService, Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceService2, Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceService3>
{
