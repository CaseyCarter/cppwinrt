...
#include "Windows.Networking.Sockets.abi.h"
#include "Windows.ApplicationModel.Background.interface.h"
...
struct IMessageWebSocket :
    ...
    impl::require<IMessageWebSocket, Windows::Networking::Sockets::IWebSocket>
{
...
struct IMessageWebSocket2 :
    ...
    impl::require<IMessageWebSocket2, Windows::Networking::Sockets::IMessageWebSocket, Windows::Networking::Sockets::IWebSocket>
{
...
struct IStreamWebSocket :
    ...
    impl::require<IStreamWebSocket, Windows::Networking::Sockets::IWebSocket>
{
...
struct IStreamWebSocket2 :
    ...
    impl::require<IStreamWebSocket2, Windows::Networking::Sockets::IStreamWebSocket, Windows::Networking::Sockets::IWebSocket>
{
