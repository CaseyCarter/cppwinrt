...
#include "Windows.Web.Http.Filters.abi.h"
...
struct IHttpBaseProtocolFilter :
    ...
    impl::require<IHttpBaseProtocolFilter, Windows::Web::Http::Filters::IHttpFilter>
{
...
struct IHttpBaseProtocolFilter2 :
    ...
    impl::require<IHttpBaseProtocolFilter2, Windows::Web::Http::Filters::IHttpFilter>
{
...
struct IHttpBaseProtocolFilter3 :
    ...
    impl::require<IHttpBaseProtocolFilter3, Windows::Web::Http::Filters::IHttpFilter>
{
...
struct IHttpBaseProtocolFilter4 :
    ...
    impl::require<IHttpBaseProtocolFilter4, Windows::Web::Http::Filters::IHttpFilter>
{
