...
#include "Windows.Media.SpeechSynthesis.abi.h"
#include "Windows.Storage.Streams.interface.h"
...
struct ISpeechSynthesisStream :
    ...
    impl::require<ISpeechSynthesisStream, Windows::Storage::Streams::IContentTypeProvider, Windows::Storage::Streams::IInputStream, Windows::Storage::Streams::IOutputStream, Windows::Storage::Streams::IRandomAccessStream, Windows::Storage::Streams::IRandomAccessStreamWithContentType>
{
