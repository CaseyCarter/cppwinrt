...
template <typename D> Windows::Globalization::Fonts::LanguageFont impl_ILanguageFontGroup<D>::UITextFont() const
{
    ...
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_UITextFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_UIHeadingFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_UITitleFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_UICaptionFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_UINotificationHeadingFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_TraditionalDocumentFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_ModernDocumentFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_DocumentHeadingFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_FixedWidthTextFont(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_DocumentAlternate1Font(put(value)));
    return value;
}
...
{
    Windows::Globalization::Fonts::LanguageFont value { nullptr };
    check_hresult(WINRT_SHIM(ILanguageFontGroup)->get_DocumentAlternate2Font(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILanguageFont)->get_FontFamily(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Text::FontWeight impl_ILanguageFont<D>::FontWeight() const
{
    ...
    check_hresult(WINRT_SHIM(ILanguageFont)->get_FontWeight(put(weight)));
    return weight;
}
