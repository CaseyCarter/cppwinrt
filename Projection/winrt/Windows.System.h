...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IMemoryManagerStatics)->add_AppMemoryUsageIncreased(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IMemoryManagerStatics)->add_AppMemoryUsageDecreased(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IMemoryManagerStatics)->add_AppMemoryUsageLimitChanging(get(handler), &token));
    return token;
}
...
template <typename D> Windows::System::AppMemoryReport impl_IMemoryManagerStatics2<D>::GetAppMemoryReport() const
{
    ...
    check_hresult(WINRT_SHIM(IMemoryManagerStatics2)->abi_GetAppMemoryReport(put(memoryReport)));
    return memoryReport;
}
...
template <typename D> Windows::System::ProcessMemoryReport impl_IMemoryManagerStatics2<D>::GetProcessMemoryReport() const
{
    ...
    check_hresult(WINRT_SHIM(IMemoryManagerStatics2)->abi_GetProcessMemoryReport(put(memoryReport)));
    return memoryReport;
}
...
{
    check_hresult(WINRT_SHIM(IProtocolForResultsOperation)->abi_ReportCompleted(get(data)));
}

template <typename D> hstring impl_IUser<D>::NonRoamableId() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IUser)->get_NonRoamableId(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IPropertySet> impl_IUser<D>::GetPropertiesAsync(const Windows::Foundation::Collections::IVectorView<hstring> & values) const
{
    ...
    check_hresult(WINRT_SHIM(IUser)->abi_GetPropertiesAsync(get(values), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::Streams::IRandomAccessStreamReference> impl_IUser<D>::GetPictureAsync(Windows::System::UserPictureSize desiredSize) const
{
    ...
    check_hresult(WINRT_SHIM(IUser)->abi_GetPictureAsync(desiredSize, put(operation)));
    return operation;
}
...
template <typename D> Windows::System::UserWatcher impl_IUserStatics<D>::CreateWatcher() const
{
    ...
    check_hresult(WINRT_SHIM(IUserStatics)->abi_CreateWatcher(put(watcher)));
    return watcher;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::System::User>> impl_IUserStatics<D>::FindAllAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IUserStatics)->abi_FindAllAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::System::User>> operation;
    check_hresult(WINRT_SHIM(IUserStatics)->abi_FindAllAsyncByType(type, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::System::User>> operation;
    check_hresult(WINRT_SHIM(IUserStatics)->abi_FindAllAsyncByTypeAndStatus(type, status, put(operation)));
    return operation;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_Added(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_Removed(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_Updated(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_AuthenticationStatusChanged(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_AuthenticationStatusChanging(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_EnumerationCompleted(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserWatcher)->add_Stopped(get(handler), &token));
    return token;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IUserChangedEventArgs)->get_User(put(value)));
    return value;
}
...
template <typename D> Windows::System::UserAuthenticationStatusChangeDeferral impl_IUserAuthenticationStatusChangingEventArgs<D>::GetDeferral() const
{
    ...
    check_hresult(WINRT_SHIM(IUserAuthenticationStatusChangingEventArgs)->abi_GetDeferral(put(deferral)));
    return deferral;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IUserAuthenticationStatusChangingEventArgs)->get_User(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_DisplayName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_FirstName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_LastName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_ProviderName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_AccountName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_GuestHost(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_PrincipalName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_DomainName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IKnownUserPropertiesStatics)->get_SessionInitiationProtocolUri(put(value)));
    return value;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IUserPicker)->get_SuggestedSelectedUser(put(value)));
    return value;
}

template <typename D> void impl_IUserPicker<D>::SuggestedSelectedUser(const Windows::System::User & value) const
{
    check_hresult(WINRT_SHIM(IUserPicker)->put_SuggestedSelectedUser(get(value)));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::System::User> impl_IUserPicker<D>::PickSingleUserAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IUserPicker)->abi_PickSingleUserAsync(put(pickSingleUserOperation)));
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IUserDeviceAssociationChangedEventArgs)->get_DeviceId(put(value)));
    return value;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IUserDeviceAssociationChangedEventArgs)->get_NewUser(put(value)));
    return value;
}
...
{
    Windows::System::User value { nullptr };
    check_hresult(WINRT_SHIM(IUserDeviceAssociationChangedEventArgs)->get_OldUser(put(value)));
    return value;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IUserDeviceAssociationStatics)->add_UserDeviceAssociationChanged(get(handler), &token));
    return token;
}
...
template <typename D> Windows::Foundation::Collections::ValueSet impl_ILaunchUriResult<D>::Result() const
{
    ...
    check_hresult(WINRT_SHIM(ILaunchUriResult)->get_Result(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::Point> impl_ILauncherUIOptions<D>::InvocationPoint() const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherUIOptions)->get_InvocationPoint(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ILauncherUIOptions)->put_InvocationPoint(get(value)));
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::Rect> impl_ILauncherUIOptions<D>::SelectionRect() const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherUIOptions)->get_SelectionRect(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ILauncherUIOptions)->put_SelectionRect(get(value)));
}
...
template <typename D> Windows::System::LauncherUIOptions impl_ILauncherOptions<D>::UI() const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherOptions)->get_UI(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILauncherOptions)->get_PreferredApplicationPackageFamilyName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILauncherOptions)->get_PreferredApplicationDisplayName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Uri impl_ILauncherOptions<D>::FallbackUri() const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherOptions)->get_FallbackUri(put(value)));
    return value;
}

template <typename D> void impl_ILauncherOptions<D>::FallbackUri(const Windows::Foundation::Uri & value) const
{
    check_hresult(WINRT_SHIM(ILauncherOptions)->put_FallbackUri(get(value)));
}

template <typename D> hstring impl_ILauncherOptions<D>::ContentType() const
{
    hstring value;
    check_hresult(WINRT_SHIM(ILauncherOptions)->get_ContentType(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(ILauncherOptions2)->get_TargetApplicationPackageFamilyName(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Search::StorageFileQueryResult impl_ILauncherOptions2<D>::NeighboringFilesQuery() const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherOptions2)->get_NeighboringFilesQuery(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(ILauncherOptions2)->put_NeighboringFilesQuery(get(value)));
}
...
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(WINRT_SHIM(IRemoteLauncherOptions)->get_FallbackUri(put(value)));
    return value;
}

template <typename D> void impl_IRemoteLauncherOptions<D>::FallbackUri(const Windows::Foundation::Uri & value) const
{
    check_hresult(WINRT_SHIM(IRemoteLauncherOptions)->put_FallbackUri(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IRemoteLauncherOptions<D>::PreferredAppIds() const
{
    ...
    check_hresult(WINRT_SHIM(IRemoteLauncherOptions)->get_PreferredAppIds(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Storage::IStorageItem> impl_IFolderLauncherOptions<D>::ItemsToSelect() const
{
    ...
    check_hresult(WINRT_SHIM(IFolderLauncherOptions)->get_ItemsToSelect(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<bool> impl_ILauncherStatics<D>::LaunchFileAsync(const Windows::Storage::IStorageFile & file) const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherStatics)->abi_LaunchFileAsync(get(file), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics)->abi_LaunchFileWithOptionsAsync(get(file), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics)->abi_LaunchUriAsync(get(uri), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics)->abi_LaunchUriWithOptionsAsync(get(uri), get(options), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::System::LaunchUriResult> impl_ILauncherStatics2<D>::LaunchUriForResultsAsync(const Windows::Foundation::Uri & uri, const Windows::System::LauncherOptions & options) const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherStatics2)->abi_LaunchUriForResultsAsync(get(uri), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::System::LaunchUriResult> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics2)->abi_LaunchUriForResultsWithDataAsync(get(uri), get(options), get(inputData), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics2)->abi_LaunchUriWithDataAsync(get(uri), get(options), get(inputData), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchQuerySupportStatus> impl_ILauncherStatics2<D>::QueryUriSupportAsync(const Windows::Foundation::Uri & uri, Windows::System::LaunchQuerySupportType launchQuerySupportType) const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherStatics2)->abi_QueryUriSupportAsync(get(uri), launchQuerySupportType, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchQuerySupportStatus> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics2)->abi_QueryFileSupportAsync(get(file), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics3)->abi_LaunchFolderAsync(get(folder), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics3)->abi_LaunchFolderWithOptionsAsync(get(folder), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchQuerySupportStatus> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_QueryAppUriSupportAsync(get(uri), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::AppInfo>> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_FindAppUriHandlersAsync(get(uri), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchUriStatus> impl_ILauncherStatics4<D>::LaunchUriForUserAsync(const Windows::System::User & user, const Windows::Foundation::Uri & uri) const
{
    ...
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_LaunchUriForUserAsync(get(user), get(uri), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchUriStatus> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_LaunchUriWithOptionsForUserAsync(get(user), get(uri), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::LaunchUriStatus> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_LaunchUriWithDataForUserAsync(get(user), get(uri), get(options), get(inputData), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::System::LaunchUriResult> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_LaunchUriForResultsForUserAsync(get(user), get(uri), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::System::LaunchUriResult> operation;
    check_hresult(WINRT_SHIM(ILauncherStatics4)->abi_LaunchUriForResultsWithDataForUserAsync(get(user), get(uri), get(options), get(inputData), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::System::RemoteLaunchUriStatus> impl_IRemoteLauncherStatics<D>::LaunchUriAsync(const Windows::System::RemoteSystems::RemoteSystemConnectionRequest & remoteSystemConnectionRequest, const Windows::Foundation::Uri & uri) const
{
    ...
    check_hresult(WINRT_SHIM(IRemoteLauncherStatics)->abi_LaunchUriAsync(get(remoteSystemConnectionRequest), get(uri), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::RemoteLaunchUriStatus> operation;
    check_hresult(WINRT_SHIM(IRemoteLauncherStatics)->abi_LaunchUriWithOptionsAsync(get(remoteSystemConnectionRequest), get(uri), get(options), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::System::RemoteLaunchUriStatus> operation;
    check_hresult(WINRT_SHIM(IRemoteLauncherStatics)->abi_LaunchUriWithDataAsync(get(remoteSystemConnectionRequest), get(uri), get(options), get(inputData), put(operation)));
    return operation;
}
