...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderLaunchActionVerbsStatics)->get_AddAppointment(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderLaunchActionVerbsStatics)->get_ReplaceAppointment(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderLaunchActionVerbsStatics)->get_RemoveAppointment(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderLaunchActionVerbsStatics)->get_ShowTimeFrame(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentsProviderLaunchActionVerbsStatics2)->get_ShowAppointmentDetails(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::Appointment impl_IAddAppointmentOperation<D>::AppointmentInformation() const
{
    ...
    check_hresult(WINRT_SHIM(IAddAppointmentOperation)->get_AppointmentInformation(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAddAppointmentOperation)->get_SourcePackageFamilyName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IReplaceAppointmentOperation)->get_AppointmentId(put(value)));
    return value;
}
...
{
    Windows::ApplicationModel::Appointments::Appointment value { nullptr };
    check_hresult(WINRT_SHIM(IReplaceAppointmentOperation)->get_AppointmentInformation(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IReplaceAppointmentOperation<D>::InstanceStartDate() const
{
    ...
    check_hresult(WINRT_SHIM(IReplaceAppointmentOperation)->get_InstanceStartDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IReplaceAppointmentOperation)->get_SourcePackageFamilyName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IRemoveAppointmentOperation)->get_AppointmentId(put(value)));
    return value;
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IRemoveAppointmentOperation)->get_InstanceStartDate(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IRemoveAppointmentOperation)->get_SourcePackageFamilyName(put(value)));
    return value;
}
