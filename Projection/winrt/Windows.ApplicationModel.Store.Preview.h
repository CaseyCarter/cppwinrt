...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewProductInfo)->get_ProductId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewProductInfo)->get_ProductType(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewProductInfo)->get_Title(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewProductInfo)->get_Description(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::StorePreviewSkuInfo> impl_IStorePreviewProductInfo<D>::SkuInfoList() const
{
    ...
    check_hresult(WINRT_SHIM(IStorePreviewProductInfo)->get_SkuInfoList(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_ProductId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_SkuId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_SkuType(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_Title(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_Description(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_CustomDeveloperData(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_CurrencyCode(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_FormattedListPrice(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStorePreviewSkuInfo)->get_ExtendedData(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::StorePreviewProductInfo>> impl_IStorePreview<D>::LoadAddOnProductInfosAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IStorePreview)->abi_LoadAddOnProductInfosAsync(put(loadAddOnProductInfosOperation)));
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStoreHardwareManufacturerInfo)->get_HardwareManufacturerId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStoreHardwareManufacturerInfo)->get_StoreContentModifierId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStoreHardwareManufacturerInfo)->get_ModelName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IStoreHardwareManufacturerInfo)->get_ManufacturerName(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Store::Preview::StoreHardwareManufacturerInfo impl_IStoreConfigurationStatics<D>::HardwareManufacturerInfo() const
{
    ...
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics)->get_HardwareManufacturerInfo(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<winrt::Windows::ApplicationModel::Store::Preview::StoreSystemFeature>> impl_IStoreConfigurationStatics<D>::FilterUnsupportedSystemFeaturesAsync(const Windows::Foundation::Collections::IIterable<winrt::Windows::ApplicationModel::Store::Preview::StoreSystemFeature> & systemFeatures) const
{
    ...
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics)->abi_FilterUnsupportedSystemFeaturesAsync(get(systemFeatures), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IReference<uint32_t> impl_IStoreConfigurationStatics2<D>::PurchasePromptingPolicy() const
{
    ...
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics2)->get_PurchasePromptingPolicy(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics2)->put_PurchasePromptingPolicy(get(value)));
}
...
{
    bool value {};
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics3)->abi_HasStoreWebAccountForUser(get(user), &value));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::Streams::IRandomAccessStreamReference> impl_IStoreConfigurationStatics3<D>::GetStoreLogDataAsync(Windows::ApplicationModel::Store::Preview::StoreLogOptions options) const
{
    ...
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics3)->abi_GetStoreLogDataAsync(options, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IReference<uint32_t> value;
    check_hresult(WINRT_SHIM(IStoreConfigurationStatics3)->abi_GetPurchasePromptingPolicyForUser(get(user), put(value)));
    return value;
}
