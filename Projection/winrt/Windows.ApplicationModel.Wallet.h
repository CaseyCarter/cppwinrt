...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletBarcode)->get_Value(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::Streams::IRandomAccessStreamReference> impl_IWalletBarcode<D>::GetImageAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletBarcode)->abi_GetImageAsync(put(operation)));
    return operation;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItemCustomProperty)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItemCustomProperty)->get_Value(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletVerb)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_DisplayName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_Id(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_IssuerDisplayName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IWalletItem<D>::LastUpdated() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItem)->get_LastUpdated(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_LastUpdated(get(value)));
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_ExpirationDate(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::Logo159x159() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_Logo159x159(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_Logo159x159(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::Logo336x336() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_Logo336x336(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_Logo336x336(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::Logo99x99() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_Logo99x99(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_Logo99x99(get(value)));
}

template <typename D> hstring impl_IWalletItem<D>::DisplayMessage() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_DisplayMessage(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_LogoText(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_HeaderBackgroundImage(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::BodyBackgroundImage() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_BodyBackgroundImage(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_BodyBackgroundImage(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::LogoImage() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_LogoImage(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_LogoImage(get(value)));
}

template <typename D> Windows::Storage::Streams::IRandomAccessStreamReference impl_IWalletItem<D>::PromotionalImage() const
{
    Windows::Storage::Streams::IRandomAccessStreamReference value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_PromotionalImage(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_PromotionalImage(get(value)));
}

template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IWalletItem<D>::RelevantDate() const
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_RelevantDate(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletItem)->put_RelevantDate(get(value)));
}

template <typename D> hstring impl_IWalletItem<D>::RelevantDateDisplayMessage() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletItem)->get_RelevantDateDisplayMessage(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletTransaction> impl_IWalletItem<D>::TransactionHistory() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItem)->get_TransactionHistory(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletRelevantLocation> impl_IWalletItem<D>::RelevantLocations() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItem)->get_RelevantLocations(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletItemCustomProperty> impl_IWalletItem<D>::DisplayProperties() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItem)->get_DisplayProperties(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::ApplicationModel::Wallet::WalletVerb> impl_IWalletItem<D>::Verbs() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItem)->get_Verbs(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletTransaction)->get_Description(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletTransaction)->get_DisplayAmount(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletTransaction)->get_DisplayLocation(put(value)));
    return value;
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IWalletTransaction)->get_TransactionDate(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletTransaction)->put_TransactionDate(get(value)));
}
...
template <typename D> Windows::Devices::Geolocation::BasicGeoposition impl_IWalletRelevantLocation<D>::Position() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletRelevantLocation)->get_Position(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IWalletRelevantLocation)->put_Position(get(value)));
}

template <typename D> hstring impl_IWalletRelevantLocation<D>::DisplayMessage() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IWalletRelevantLocation)->get_DisplayMessage(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncAction operation;
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_ClearAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Wallet::WalletItem>> impl_IWalletItemStore<D>::GetItemsAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_GetItemsAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Wallet::WalletItem>> operation;
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_GetItemsWithKindAsync(kind, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Wallet::WalletItem> operation;
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_ImportItemAsync(get(stream), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncAction operation;
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_ShowAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncAction operation;
    check_hresult(WINRT_SHIM(IWalletItemStore)->abi_UpdateAsync(get(item), put(operation)));
    return operation;
}
...
{
    event_token cookie {};
    check_hresult(WINRT_SHIM(IWalletItemStore2)->add_ItemsChanged(get(handler), &cookie));
    return cookie;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Wallet::WalletItemStore> impl_IWalletManagerStatics<D>::RequestStoreAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IWalletManagerStatics)->abi_RequestStoreAsync(put(operation)));
    return operation;
}
...
{
    Windows::ApplicationModel::Wallet::WalletBarcode barcode { nullptr };
    check_hresult(WINRT_SHIM(IWalletBarcodeFactory)->abi_CreateCustomWalletBarcode(get(streamToBarcodeImage), put(barcode)));
    return barcode;
}
