...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_IAppointmentManagerStatics<D>::ShowAddAppointmentAsync(const Windows::ApplicationModel::Appointments::Appointment & appointment, const Windows::Foundation::Rect & selection) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowAddAppointmentAsync(get(appointment), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowAddAppointmentWithPlacementAsync(get(appointment), get(selection), preferredPlacement, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowReplaceAppointmentAsync(get(appointmentId), get(appointment), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowReplaceAppointmentWithPlacementAsync(get(appointmentId), get(appointment), get(selection), preferredPlacement, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowReplaceAppointmentWithPlacementAndDateAsync(get(appointmentId), get(appointment), get(selection), preferredPlacement, get(instanceStartDate), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<bool> impl_IAppointmentManagerStatics<D>::ShowRemoveAppointmentAsync(hstring_view appointmentId, const Windows::Foundation::Rect & selection) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowRemoveAppointmentAsync(get(appointmentId), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowRemoveAppointmentWithPlacementAsync(get(appointmentId), get(selection), preferredPlacement, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowRemoveAppointmentWithPlacementAndDateAsync(get(appointmentId), get(selection), preferredPlacement, get(instanceStartDate), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_IAppointmentManagerStatics<D>::ShowTimeFrameAsync(const Windows::Foundation::DateTime & timeToShow, const Windows::Foundation::TimeSpan & duration) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics)->abi_ShowTimeFrameAsync(get(timeToShow), get(duration), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics2)->abi_ShowAppointmentDetailsAsync(get(appointmentId), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics2)->abi_ShowAppointmentDetailsWithDateAsync(get(appointmentId), get(instanceStartDate), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics2)->abi_ShowEditNewAppointmentAsync(get(appointment), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentStore> impl_IAppointmentManagerStatics2<D>::RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics2)->abi_RequestStoreAsync(options, put(operation)));
    return operation;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentManagerForUser impl_IAppointmentManagerStatics3<D>::GetForUser(const Windows::System::User & user) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerStatics3)->abi_GetForUser(get(user), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<hstring> impl_IAppointmentManagerForUser<D>::ShowAddAppointmentAsync(const Windows::ApplicationModel::Appointments::Appointment & appointment, const Windows::Foundation::Rect & selection) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowAddAppointmentAsync(get(appointment), get(selection), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowAddAppointmentWithPlacementAsync(get(appointment), get(selection), preferredPlacement, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowReplaceAppointmentAsync(get(appointmentId), get(appointment), get(selection), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowReplaceAppointmentWithPlacementAsync(get(appointmentId), get(appointment), get(selection), preferredPlacement, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowReplaceAppointmentWithPlacementAndDateAsync(get(appointmentId), get(appointment), get(selection), preferredPlacement, get(instanceStartDate), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<bool> impl_IAppointmentManagerForUser<D>::ShowRemoveAppointmentAsync(hstring_view appointmentId, const Windows::Foundation::Rect & selection) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowRemoveAppointmentAsync(get(appointmentId), get(selection), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowRemoveAppointmentWithPlacementAsync(get(appointmentId), get(selection), preferredPlacement, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowRemoveAppointmentWithPlacementAndDateAsync(get(appointmentId), get(selection), preferredPlacement, get(instanceStartDate), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_IAppointmentManagerForUser<D>::ShowTimeFrameAsync(const Windows::Foundation::DateTime & timeToShow, const Windows::Foundation::TimeSpan & duration) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowTimeFrameAsync(get(timeToShow), get(duration), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowAppointmentDetailsAsync(get(appointmentId), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowAppointmentDetailsWithDateAsync(get(appointmentId), get(instanceStartDate), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> result;
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_ShowEditNewAppointmentAsync(get(appointment), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentStore> impl_IAppointmentManagerForUser<D>::RequestStoreAsync(Windows::ApplicationModel::Appointments::AppointmentStoreAccessType options) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->abi_RequestStoreAsync(options, put(result)));
    return result;
}
...
template <typename D> Windows::System::User impl_IAppointmentManagerForUser<D>::User() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentManagerForUser)->get_User(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentParticipant)->get_DisplayName(put(value)));
    return value;
}

template <typename D> void impl_IAppointmentParticipant<D>::DisplayName(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointmentParticipant)->put_DisplayName(get(value)));
}

template <typename D> hstring impl_IAppointmentParticipant<D>::Address() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentParticipant)->get_Address(put(value)));
    return value;
}

template <typename D> void impl_IAppointmentParticipant<D>::Address(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointmentParticipant)->put_Address(get(value)));
}
...
template <typename D> Windows::Foundation::IReference<uint32_t> impl_IAppointmentRecurrence<D>::Occurrences() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentRecurrence)->get_Occurrences(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointmentRecurrence)->put_Occurrences(get(value)));
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IAppointmentRecurrence<D>::Until() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentRecurrence)->get_Until(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointmentRecurrence)->put_Until(get(value)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentRecurrence2)->get_TimeZone(put(value)));
    return value;
}

template <typename D> void impl_IAppointmentRecurrence2<D>::TimeZone(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointmentRecurrence2)->put_TimeZone(get(value)));
}

template <typename D> hstring impl_IAppointmentRecurrence3<D>::CalendarIdentifier() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentRecurrence3)->get_CalendarIdentifier(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::TimeSpan> impl_IAppointment<D>::Reminder() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointment)->get_Reminder(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointment)->put_Reminder(get(value)));
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentOrganizer impl_IAppointment<D>::Organizer() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointment)->get_Organizer(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointment)->put_Organizer(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::ApplicationModel::Appointments::AppointmentInvitee> impl_IAppointment<D>::Invitees() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointment)->get_Invitees(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentRecurrence impl_IAppointment<D>::Recurrence() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointment)->get_Recurrence(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointment)->put_Recurrence(get(value)));
}
...
template <typename D> Windows::Foundation::Uri impl_IAppointment<D>::Uri() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointment)->get_Uri(put(value)));
    return value;
}

template <typename D> void impl_IAppointment<D>::Uri(const Windows::Foundation::Uri & value) const
{
    check_hresult(WINRT_SHIM(IAppointment)->put_Uri(get(value)));
}

template <typename D> hstring impl_IAppointment2<D>::LocalId() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_LocalId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_CalendarId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_RoamingId(put(value)));
    return value;
}

template <typename D> void impl_IAppointment2<D>::RoamingId(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointment2)->put_RoamingId(get(value)));
}
...
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_OriginalStartTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_OnlineMeetingLink(put(value)));
    return value;
}

template <typename D> void impl_IAppointment2<D>::OnlineMeetingLink(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointment2)->put_OnlineMeetingLink(get(value)));
}

template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IAppointment2<D>::ReplyTime() const
{
    Windows::Foundation::IReference<Windows::Foundation::DateTime> value;
    check_hresult(WINRT_SHIM(IAppointment2)->get_ReplyTime(put(value)));
    return value;
}
...
{
    check_hresult(WINRT_SHIM(IAppointment2)->put_ReplyTime(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IFindAppointmentsOptions<D>::CalendarIds() const
{
    ...
    check_hresult(WINRT_SHIM(IFindAppointmentsOptions)->get_CalendarIds(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(WINRT_SHIM(IFindAppointmentsOptions)->get_FetchProperties(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Color impl_IAppointmentCalendar<D>::DisplayColor() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->get_DisplayColor(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->get_DisplayName(put(value)));
    return value;
}

template <typename D> void impl_IAppointmentCalendar<D>::DisplayName(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->put_DisplayName(get(value)));
}

template <typename D> hstring impl_IAppointmentCalendar<D>::LocalId() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->get_LocalId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->get_SourceDisplayName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> impl_IAppointmentCalendar<D>::FindAppointmentsAsync(const Windows::Foundation::DateTime & rangeStart, const Windows::Foundation::TimeSpan & rangeLength) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindAppointmentsAsync(get(rangeStart), get(rangeLength), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindAppointmentsAsyncWithOptions(get(rangeStart), get(rangeLength), get(options), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::AppointmentException>> impl_IAppointmentCalendar<D>::FindExceptionsFromMasterAsync(hstring_view masterLocalId) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindExceptionsFromMasterAsync(get(masterLocalId), put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> impl_IAppointmentCalendar<D>::FindAllInstancesAsync(hstring_view masterLocalId, const Windows::Foundation::DateTime & rangeStart, const Windows::Foundation::TimeSpan & rangeLength) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindAllInstancesAsync(get(masterLocalId), get(rangeStart), get(rangeLength), put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindAllInstancesAsyncWithOptions(get(masterLocalId), get(rangeStart), get(rangeLength), get(pOptions), put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::Appointment> impl_IAppointmentCalendar<D>::GetAppointmentAsync(hstring_view localId) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_GetAppointmentAsync(get(localId), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::Appointment> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_GetAppointmentInstanceAsync(get(localId), get(instanceStartTime), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindUnexpandedAppointmentsAsync(put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_FindUnexpandedAppointmentsAsyncWithOptions(get(options), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_DeleteAsync(put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_SaveAsync(put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_DeleteAppointmentAsync(get(localId), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_DeleteAppointmentInstanceAsync(get(localId), get(instanceStartTime), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentCalendar)->abi_SaveAppointmentAsync(get(pAppointment), put(asyncAction)));
    return asyncAction;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentCalendarSyncManager impl_IAppointmentCalendar2<D>::SyncManager() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->get_SyncManager(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->get_RemoteId(put(value)));
    return value;
}

template <typename D> void impl_IAppointmentCalendar2<D>::RemoteId(hstring_view value) const
{
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->put_RemoteId(get(value)));
}

template <typename D> void impl_IAppointmentCalendar2<D>::DisplayColor(const Windows::UI::Color & value) const
{
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->put_DisplayColor(get(value)));
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->get_UserDataAccountId(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->abi_TryCreateOrUpdateAppointmentAsync(get(appointment), notifyInvitees, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->abi_TryCancelMeetingAsync(get(meeting), get(subject), get(comment), notifyInvitees, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->abi_TryForwardMeetingAsync(get(meeting), get(invitees), get(subject), get(forwardHeader), get(comment), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->abi_TryProposeNewTimeForMeetingAsync(get(meeting), get(newStartTime), get(newDuration), get(subject), get(comment), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar2)->abi_TryUpdateMeetingResponseAsync(get(meeting), response, get(subject), get(comment), sendUpdate, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(WINRT_SHIM(IAppointmentCalendar3)->abi_RegisterSyncManagerAsync(put(result)));
    return result;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager)->get_LastSuccessfulSyncTime(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager)->get_LastAttemptedSyncTime(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> result;
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager)->abi_SyncAsync(put(result)));
    return result;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager)->add_SyncStatusChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager2)->put_LastSuccessfulSyncTime(get(value)));
}
...
{
    check_hresult(WINRT_SHIM(IAppointmentCalendarSyncManager2)->put_LastAttemptedSyncTime(get(value)));
}

template <typename D> hstring impl_IAppointmentPropertiesStatics<D>::Subject() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Subject(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Location(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_StartTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Duration(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Reminder(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_BusyStatus(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Sensitivity(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_OriginalStartTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_IsResponseRequested(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_AllowNewTimeProposal(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_AllDay(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Details(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_OnlineMeetingLink(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_ReplyTime(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Organizer(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_UserResponse(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_HasInvitees(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_IsCanceledMeeting(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_IsOrganizedByUser(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Recurrence(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Uri(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_Invitees(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics)->get_DefaultProperties(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics2)->get_ChangeNumber(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics2)->get_RemoteChangeNumber(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppointmentPropertiesStatics2)->get_DetailsKind(put(value)));
    return value;
}
...
{
    Windows::Foundation::DateTime value {};
    check_hresult(WINRT_SHIM(IAppointmentConflictResult)->get_Date(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::Appointment impl_IAppointmentStoreChange<D>::Appointment() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStoreChange)->get_Appointment(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentCalendar impl_IAppointmentStoreChange2<D>::AppointmentCalendar() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStoreChange2)->get_AppointmentCalendar(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::AppointmentStoreChange>> impl_IAppointmentStoreChangeReader<D>::ReadBatchAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStoreChangeReader)->abi_ReadBatchAsync(put(result)));
    return result;
}
...
{
    check_hresult(WINRT_SHIM(IAppointmentStoreChangeReader)->abi_AcceptChangesThrough(get(lastChangeToAccept)));
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentStoreChangeReader impl_IAppointmentStoreChangeTracker<D>::GetChangeReader() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStoreChangeTracker)->abi_GetChangeReader(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentStoreChangedDeferral impl_IAppointmentStoreChangedEventArgs<D>::GetDeferral() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStoreChangedEventArgs)->abi_GetDeferral(put(result)));
    return result;
}
...
template <typename D> Windows::ApplicationModel::Appointments::AppointmentStoreChangeTracker impl_IAppointmentStore<D>::ChangeTracker() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->get_ChangeTracker(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentCalendar> impl_IAppointmentStore<D>::CreateAppointmentCalendarAsync(hstring_view name) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_CreateAppointmentCalendarAsync(get(name), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentCalendar> impl_IAppointmentStore<D>::GetAppointmentCalendarAsync(hstring_view calendarId) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_GetAppointmentCalendarAsync(get(calendarId), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::Appointment> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_GetAppointmentAsync(get(localId), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::Appointment> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_GetAppointmentInstanceAsync(get(localId), get(instanceStartTime), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::AppointmentCalendar>> impl_IAppointmentStore<D>::FindAppointmentCalendarsAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindAppointmentCalendarsAsync(put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::AppointmentCalendar>> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindAppointmentCalendarsAsyncWithOptions(options, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindAppointmentsAsync(get(rangeStart), get(rangeLength), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Appointments::Appointment>> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindAppointmentsAsyncWithOptions(get(rangeStart), get(rangeLength), get(options), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentConflictResult> impl_IAppointmentStore<D>::FindConflictAsync(const Windows::ApplicationModel::Appointments::Appointment & appointment) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindConflictAsync(get(appointment), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentConflictResult> result;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindConflictAsyncWithInstanceStart(get(appointment), get(instanceStartTime), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_MoveAppointmentAsync(get(appointment), get(destinationCalendar), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowAddAppointmentAsync(get(appointment), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowReplaceAppointmentAsync(get(localId), get(appointment), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowReplaceAppointmentWithPlacementAndDateAsync(get(localId), get(appointment), get(selection), preferredPlacement, get(instanceStartDate), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowRemoveAppointmentAsync(get(localId), get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowRemoveAppointmentWithPlacementAndDateAsync(get(localId), get(selection), preferredPlacement, get(instanceStartDate), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowAppointmentDetailsAsync(get(localId), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowAppointmentDetailsWithDateAsync(get(localId), get(instanceStartDate), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncOperation<hstring> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_ShowEditNewAppointmentAsync(get(appointment), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<hstring>> impl_IAppointmentStore<D>::FindLocalIdsFromRoamingIdAsync(hstring_view roamingId) const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentStore)->abi_FindLocalIdsFromRoamingIdAsync(get(roamingId), put(operation)));
    return operation;
}
...
{
    event_token pToken {};
    check_hresult(WINRT_SHIM(IAppointmentStore2)->add_StoreChanged(get(pHandler), &pToken));
    return pToken;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Appointments::AppointmentCalendar> operation;
    check_hresult(WINRT_SHIM(IAppointmentStore2)->abi_CreateAppointmentCalendarInAccountAsync(get(name), get(userDataAccountId), put(operation)));
    return operation;
}
...
{
    Windows::ApplicationModel::Appointments::Appointment value { nullptr };
    check_hresult(WINRT_SHIM(IAppointmentException)->get_Appointment(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IAppointmentException<D>::ExceptionProperties() const
{
    ...
    check_hresult(WINRT_SHIM(IAppointmentException)->get_ExceptionProperties(put(value)));
    return value;
}
