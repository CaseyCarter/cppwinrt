...
template <typename D> Windows::ApplicationModel::AppService::AppServiceRequest impl_IAppServiceRequestReceivedEventArgs<D>::Request() const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceRequestReceivedEventArgs)->get_Request(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::AppService::AppServiceDeferral impl_IAppServiceRequestReceivedEventArgs<D>::GetDeferral() const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceRequestReceivedEventArgs)->abi_GetDeferral(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::AppService::AppServiceConnectionStatus> impl_IAppServiceConnection2<D>::OpenRemoteAsync(const Windows::System::RemoteSystems::RemoteSystemConnectionRequest & remoteSystemConnectionRequest) const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceConnection2)->abi_OpenRemoteAsync(get(remoteSystemConnectionRequest), put(operation)));
    return operation;
}
...
template <typename D> Windows::System::User impl_IAppServiceConnection2<D>::User() const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceConnection2)->get_User(put(value)));
    return value;
}

template <typename D> void impl_IAppServiceConnection2<D>::User(const Windows::System::User & value) const
{
    check_hresult(WINRT_SHIM(IAppServiceConnection2)->put_User(get(value)));
}

template <typename D> hstring impl_IAppServiceTriggerDetails<D>::Name() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppServiceTriggerDetails)->get_Name(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppServiceTriggerDetails)->get_CallerPackageFamilyName(put(value)));
    return value;
}
...
template <typename D> Windows::ApplicationModel::AppService::AppServiceConnection impl_IAppServiceTriggerDetails<D>::AppServiceConnection() const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceTriggerDetails)->get_AppServiceConnection(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::ValueSet impl_IAppServiceRequest<D>::Message() const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceRequest)->get_Message(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::AppService::AppServiceResponseStatus> impl_IAppServiceRequest<D>::SendResponseAsync(const Windows::Foundation::Collections::ValueSet & message) const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceRequest)->abi_SendResponseAsync(get(message), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::Collections::ValueSet value { nullptr };
    check_hresult(WINRT_SHIM(IAppServiceResponse)->get_Message(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppServiceConnection)->get_AppServiceName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IAppServiceConnection)->get_PackageFamilyName(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::AppService::AppServiceConnectionStatus> operation;
    check_hresult(WINRT_SHIM(IAppServiceConnection)->abi_OpenAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::AppService::AppServiceResponse> impl_IAppServiceConnection<D>::SendMessageAsync(const Windows::Foundation::Collections::ValueSet & message) const
{
    ...
    check_hresult(WINRT_SHIM(IAppServiceConnection)->abi_SendMessageAsync(get(message), put(operation)));
    return operation;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IAppServiceConnection)->add_RequestReceived(get(handler), &token));
    return token;
}
...
{
    event_token token {};
    check_hresult(WINRT_SHIM(IAppServiceConnection)->add_ServiceClosed(get(handler), &token));
    return token;
}
