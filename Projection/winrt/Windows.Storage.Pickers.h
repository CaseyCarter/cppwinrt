...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileOpenPicker)->get_SettingsIdentifier(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileOpenPicker)->get_CommitButtonText(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IFileOpenPicker<D>::FileTypeFilter() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPicker)->get_FileTypeFilter(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::StorageFile> impl_IFileOpenPicker<D>::PickSingleFileAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPicker)->abi_PickSingleFileAsync(put(pickSingleFileOperation)));
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Storage::StorageFile>> impl_IFileOpenPicker<D>::PickMultipleFilesAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPicker)->abi_PickMultipleFilesAsync(put(pickMultipleFilesOperation)));
...
template <typename D> Windows::Foundation::Collections::ValueSet impl_IFileOpenPicker2<D>::ContinuationData() const
{
    ...
    check_hresult(WINRT_SHIM(IFileOpenPicker2)->get_ContinuationData(put(value)));
    return value;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Storage::StorageFile> pickSingleFileOperation;
    check_hresult(WINRT_SHIM(IFileOpenPickerStatics)->abi_ResumePickSingleFileAsync(put(pickSingleFileOperation)));
    return pickSingleFileOperation;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_SettingsIdentifier(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_CommitButtonText(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, Windows::Foundation::Collections::IVector<hstring>> impl_IFileSavePicker<D>::FileTypeChoices() const
{
    ...
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_FileTypeChoices(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_DefaultFileExtension(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::StorageFile impl_IFileSavePicker<D>::SuggestedSaveFile() const
{
    ...
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_SuggestedSaveFile(put(value)));
    return value;
}

template <typename D> void impl_IFileSavePicker<D>::SuggestedSaveFile(const Windows::Storage::StorageFile & value) const
{
    check_hresult(WINRT_SHIM(IFileSavePicker)->put_SuggestedSaveFile(get(value)));
}

template <typename D> hstring impl_IFileSavePicker<D>::SuggestedFileName() const
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePicker)->get_SuggestedFileName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::StorageFile> impl_IFileSavePicker<D>::PickSaveFileAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IFileSavePicker)->abi_PickSaveFileAsync(put(pickSaveFileOperation)));
...
{
    Windows::Foundation::Collections::ValueSet value { nullptr };
    check_hresult(WINRT_SHIM(IFileSavePicker2)->get_ContinuationData(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFileSavePicker3)->get_EnterpriseId(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFolderPicker)->get_SettingsIdentifier(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(WINRT_SHIM(IFolderPicker)->get_CommitButtonText(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(WINRT_SHIM(IFolderPicker)->get_FileTypeFilter(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Storage::StorageFolder> impl_IFolderPicker<D>::PickSingleFolderAsync() const
{
    ...
    check_hresult(WINRT_SHIM(IFolderPicker)->abi_PickSingleFolderAsync(put(pickSingleFolderOperation)));
...
{
    Windows::Foundation::Collections::ValueSet value { nullptr };
    check_hresult(WINRT_SHIM(IFolderPicker2)->get_ContinuationData(put(value)));
    return value;
}
