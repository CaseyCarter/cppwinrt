...
static void AsyncOperationProgressHandler_Free(const IAsyncOperationWithProgress<bool, double> & sender, double args)
{
    REQUIRE(sender == nullptr);
    REQUIRE(args == 123.0);
}
...
{
    void Handler(const IAsyncOperationWithProgress<bool, double> & sender, double args)
    {
        REQUIRE(sender == nullptr);
        REQUIRE(args == 123.0);
    }
...
TEST_CASE("delegate,AsyncOperationProgressHandler")
{
    ...
    SECTION("default")
    {
        AsyncOperationProgressHandler<bool, double> a;
        AsyncOperationProgressHandler<bool, double> b = nullptr;
    }

    SECTION("lambda")
    {
        AsyncOperationProgressHandler<bool, double> h = [](const IAsyncOperationWithProgress<bool, double> & sender, double args)
        {
            REQUIRE(sender == nullptr);
            REQUIRE(args == 123.0);
        };
    ...
    SECTION("free function")
    {
        AsyncOperationProgressHandler<bool, double> h = AsyncOperationProgressHandler_Free;
        h(nullptr, 123.0);
    }
    ...
    SECTION("member function")
    {
        ...
        AsyncOperationProgressHandler<bool, double> h{ &object, &AsyncOperationProgressHandler_Member::Handler };
        h(nullptr, 123.0);
    }
}

static void AsyncOperationWithProgressCompletedHandler_Free(const IAsyncOperationWithProgress<bool, double> & sender, const AsyncStatus args)
{
    REQUIRE(sender == nullptr);
    REQUIRE(args == AsyncStatus::Completed);
}
...
{
    void Handler(const IAsyncOperationWithProgress<bool, double> & sender, const AsyncStatus args)
    {
        REQUIRE(sender == nullptr);
        REQUIRE(args == AsyncStatus::Completed);
    }
...
TEST_CASE("delegate,AsyncOperationWithProgressCompletedHandler")
{
    ...
    SECTION("default")
    {
        AsyncOperationWithProgressCompletedHandler<bool, double> a;
        AsyncOperationWithProgressCompletedHandler<bool, double> b = nullptr;
    }

    SECTION("lambda")
    {
        AsyncOperationWithProgressCompletedHandler<bool, double> h = [](const IAsyncOperationWithProgress<bool, double> & sender, const AsyncStatus args)
        {
            REQUIRE(sender == nullptr);
            REQUIRE(args == AsyncStatus::Completed);
        };
    ...
    SECTION("free function")
    {
        AsyncOperationWithProgressCompletedHandler<bool, double> h = AsyncOperationWithProgressCompletedHandler_Free;
        h(nullptr, AsyncStatus::Completed);
    }
    ...
    SECTION("member function")
    {
        ...
        AsyncOperationWithProgressCompletedHandler<bool, double> h{ &object, &AsyncOperationWithProgressCompletedHandler_Member::Handler };
        h(nullptr, AsyncStatus::Completed);
    }
}
...
TEST_CASE("delegate,TypedEventHandler")
{
    ...
    SECTION("default")
    {
        TypedEventHandler<IInspectable, IInspectable> a;
        TypedEventHandler<IInspectable, IInspectable> b = nullptr;
    }

    SECTION("lambda")
    {
        TypedEventHandler<IInspectable, IInspectable> h = [](const IInspectable & sender, const IInspectable & args)
        {
            REQUIRE(sender == nullptr);
            REQUIRE(args == nullptr);
        };
    ...
    SECTION("free function")
    {
        TypedEventHandler<IInspectable, IInspectable> h = TypedEventHandler_Free;
        h(nullptr, nullptr);
    }
    ...
    SECTION("member function")
    {
        ...
        TypedEventHandler<IInspectable, IInspectable> h{ &object, &TypedEventHandler_Member::Handler };
        h(nullptr, nullptr);
    }
}